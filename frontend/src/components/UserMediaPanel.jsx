    ...
    <section className="border-b border-black/10 p-3">
      <div className="mb-3 flex items-start justify-between gap-3">
        <div className="min-w-0">
          <p className="text-xs font-semibold uppercase tracking-wide text-teal">Profile</p>
          <h2 className="text-lg font-semibold text-ink">My media</h2>
        </div>
        <button
          type="button"
      ...
      {!media.length ? (
        <p className="text-sm text-stone-500">Photos and videos you upload will appear here.</p>
      ) : (
